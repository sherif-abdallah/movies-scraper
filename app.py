...
input = st.text_input("Enter Movie Url from test.ws")
...
iframe = '''
    ...
    <center><iframe class="video"  src="''' + videosrc['src'] + '''" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" sandbox="allow-scripts" sandboxscrolling="no" frameborder="0" ></iframe></center>'''
